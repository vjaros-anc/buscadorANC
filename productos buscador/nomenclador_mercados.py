...
PRODUCTOS: dict[str, dict] = {
    ...
    'BPO': {"sectores": ['Tecnologia y telecomunicaciones'], "patrones": [r"\bbpo\b"]},
    ...
    'Desarrollo de software': {"sectores": ['Tecnologia y telecomunicaciones'], "patrones": [r"desarrollo de software"]},
    ...
    'Inmobiliari': {"sectores": ['Inmobiliario, retail y shoppings'], "patrones": [r"inmobiliari"]},
    ...
    'Soluciones como servicio': {"sectores": ['Tecnologia y telecomunicaciones'], "patrones": [r"solucion(es)? como servicio"]},
